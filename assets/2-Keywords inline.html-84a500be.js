import{_ as i,r as c,o as l,c as o,d as e,w as t,a as s,b as n,e as p}from"./app-a799a61c.js";const u={},d=s("h3",{id:"内联函数",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#内联函数","aria-hidden":"true"},"#"),n(" 内联函数")],-1),r=s("br",null,null,-1),k=p(`<div class="language-cpp line-numbers-mode" data-ext="cpp"><pre class="language-cpp"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&lt;iostream&gt;</span></span>
