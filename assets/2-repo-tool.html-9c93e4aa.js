import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{r,o as t,c,a as n,b as e,d as a,e as o}from"./app-b4a375c5.js";const l={},d=n("h2",{id:"前言",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#前言","aria-hidden":"true"},"#"),e(" 前言")],-1),p={href:"https://www.chromium.org/chromium-os/quick-start-guide",target:"_blank",rel:"noopener noreferrer"},m=o(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> <span class="token variable">\${SOURCE_REPO}</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2);function h(b,_){const s=r("ExternalLinkIcon");return t(),c("div",null,[d,n("p",null,[e("有个小任务，拉取 "),n("a",p,[e("Chromium OS"),a(s)]),e(" 的代码：")]),m,n("p",null,[e("其使用到了 "),n("a",u,[e("repo"),a(s)]),e(" 工具。")]),v])}const g=i(l,[["render",h],["__file","2-repo-tool.html.vue"]]);export{g as default};
