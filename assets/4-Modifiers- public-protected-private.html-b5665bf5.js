import{_ as c,r as i,o,c as l,d as a,w as e,a as t,b as s,e as p}from"./app-e0ed3b4c.js";const d="/RenderDoc/assets/publicchat-d264fb40.png",r="/RenderDoc/assets/puprpv-e5f48be6.png",u={},v=t("h2",{id:"类-class-中",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#类-class-中","aria-hidden":"true"},"#"),s(" 类(class)中")],-1),k=t("h3",{id:"访问控制",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#访问控制","aria-hidden":"true"},"#"),s(" 访问控制")],-1),m=p('<figure><img src="'+d+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><blockquote><p><strong>Private自己可见|Protected自己和好友可见|Public所有人可见</strong></p></blockquote><ol><li><strong>Public（公共）:</strong><ul><li>成员声明为 <code>public</code> 的，可以在类的内部和外部访问。</li><li>对于类的用户来说，<code>public</code> 成员是可见的，可以直接访问。</li></ul></li></ol><div class="language-cpp line-numbers-mode" data-ext="cpp"><pre class="language-cpp"><code><span class="token keyword">class</span> <span class="token class-name">MyClass</span> <span class="token punctuation">{</span>
