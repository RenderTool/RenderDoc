...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1);function D(x,C){const t=o("ChatMessage"),c=o("GifWithButton");return i(),u("div",null,[a(t,{avatar:"../../../../assets/emoji/hx.png",avatarWidth:40},{default:p(()=>[n(" 说完了数组指针和指针数组随便讲讲结构体指针和类指针吧 ")]),_:1}),a(t,{avatar:"../../../../assets/emoji/hx.png",avatarWidth:40,alignLeft:""},{default:p(()=>[n(" 在讲结构体指针前先来复习一下结构体咱们定义吧 ")]),_:1}),m,b,g,a(t,{avatar:"../../../../assets/emoji/dsyj.png",avatarWidth:40,alignLeft:""},{default:p(()=>[n(" 顾名思义，是一个结构体类型的"),y,n("指向某个结构体。 ")]),_:1}),h,a(c,{src:"../../../../assets/unrealgif/structptr.gif"}),a(t,{avatar:"../../../../assets/emoji/hx.png",avatarWidth:40},{default:p(()=>[n(" 如果不delete会怎么样？ ")]),_:1}),a(t,{avatar:"../../../../assets/emoji/blzt.png",avatarWidth:40,alignLeft:""},{default:p(()=>[n(" 如果动态分配内存后，没有正确释放该内存，意味着这部分内存无法再被程序访问。"),w,n(" 但系统仍然认为这部分内存被程序占用，从而造成内存资源的浪费。也就是我们常常说的内存泄漏。 ")]),_:1}),f,a(t,{avatar:"../../../../assets/emoji/blzt.png",avatarWidth:40,alignLeft:""},{default:p(()=>[n(" 类指针和结构体指针在概念上非常相似，因为类（class）和结构体（struct）在 C++ 中都是用户自定义的数据类型。 只不过需要注意的是类默认是私有的,需要用pulic关键字修饰 ")]),_:1}),_,a(t,{avatar:"../../../../assets/emoji/blzt.png",avatarWidth:40,alignLeft:""},{default:p(()=>[n(" 当然结构体/类指针声明前置都是可以的 ")]),_:1}),q])}const M=l(v,[["render",D],["__file","4-Ptr-Struct.html.vue"]]);export{M as default};
