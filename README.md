...
- **内容沉淀** — 213 篇文章，覆盖 UE5、编程语言、开发工具、算法与 AI 生成等领域
- **暗色模式** — 一键切换明暗主题，适配所有界面
- **全文搜索** — 本地全文索引，支持搜索建议与历史记录
- **评论系统** — 基于 GitHub Discussions 的 Giscus 评论
- **PWA 离线支持** — 可安装为应用，支持离线访问
- **内容增强** — Tabs、代码组、标记、图片懒加载、Playground 等 Markdown 增强
- **页面加密** — 支持对敏感页面设置访问密码
- **自定义组件** — 内置聊天消息、GIF 动图按钮等个性化组件
...
<p align="center">
  <img src="src/.vuepress/public/001.png" width="45%" alt="站点首页截图 1">
  <img src="src/.vuepress/public/002.png" width="45%" alt="站点首页截图 2">
</p>
<p align="center">
  <img src="src/.vuepress/public/003.png" width="45%" alt="站点首页截图 3">
</p>

### 暗色主题

<p align="center">
  <img src="src/.vuepress/public/004.png" width="45%" alt="暗色主题截图">
</p>
